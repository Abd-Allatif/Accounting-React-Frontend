    ...
    const submitData = async (event) => {
        ...
        // Check if email is valid 
            ...
            await axios.post(`${import.meta.env.VITE_API_URL}/register/`, {
                ...
                SetResetcode(response.data.password_reset_code);
                setLoading(false);
            }).catch(error => {
                setLoading(false);
        ...
        <StyledWrapper>
            <div className='Container'>
                <form className="form">
                    ...
                    <div className="btn">
                        <button className="button1" onClick={submitData}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Register&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                        <button className="button2" onClick={returnLoginPage}>Back</button>
                    </div>
